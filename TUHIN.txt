...
logo=(cyan+"""_____ _   _ _   _ ___ _   _
|_   _| | | | | | |_ _| \ | |
  | | | | | | |_| || ||  \| |
  | | | |_| |  _  || || |\  |
  |_|  \___/|_| |_|___|_| \_|
{ab}-----------------------------------------------
{d}Github   : github.com/JANNAT4
{d}Facebook :https://https://www.facebook.com/profile.php?id=100077553519072
{ab}-----------------------------------------------""")
...
line=(blue+"======================================================")
tversion=(cyan+"\t\t   Version : PRO ")

line2=("\t\t~~~~~~~~~~~~~~~~~~~~~~~~~~")
 
dtls=(color_off+"\t\t Created By: RA TUHIN ")

note=(cyan+"Note: Welcome from TUHIN.")
...
number=str(input(white+"[âž™] Enter Your Target Number : "))
amount=int(input(cyan+"[âž™] Enter The Amount Sms(100000): "))
...
for i in range (amount):
	...
	print(str(i+1)+lightblue+'.	âž™SMS Sent BD CYBER ZONE')
	
print('					')
print(on_green+'\t\tThanks For Using BOMBER INSAN VAU')
